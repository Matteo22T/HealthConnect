...
public class VisiteService {
    ...
    public List<visitaDTO> getListaVisiteMedicoSenzaDiagnosi(Long id){ return visitaDAO.getListaVisiteMedicoSenzaDiagnosi(id); }
    ...
    public int getNumeroVisiteOdierne(){
        return visitaDAO.getNumeroVisiteOdierne();
    }
}
